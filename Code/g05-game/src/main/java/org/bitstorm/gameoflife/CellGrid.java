/**
 * Interface to Game of Life Grid. The CellGridCanvas can deal with any grid, not only the Game of
 * Life. Copyright 1996-2004 Edwin Martin <edwin@bitstorm.nl>
 *
 * @author Edwin Martin
 */
...
/**
 * Interface between GameOfLifeCanvas and GameOfLife. This way GameOfLifeCanvas is generic,
 * independent of GameOfLife. It contains generic methods to operate on a cell grid.
 *
 * @author Edwin Martin
 */
